...
export default function ContactPage() {
    return (
        <>
            ...
            {/*end breadcrumb*/}
            <div className="card rounded-4" style={{ height: 600 }}>
                <div className="card-body">
                    <h1>聯絡我們 Contact Us</h1>
                    <br />
                    <p className="mb-4">
                        如你發現本站內容有侵權、違規或有任何查詢，請隨時與我們聯絡。我們會盡快回覆及處理相關事宜。
                    </p>
                    <a href="mailto:info@dse.best" className="btn btn-primary btn-lg">
                        <i className="material-icons-outlined align-middle">email</i>
                        Email
                    </a>
                </div>
            </div>
