                ...
                <div className="card-body">
                    ...
                    <div className="row row-cols-1 row-cols-md-3 g-4 mb-4">
                        <div className="col">
                            <div className="card h-100 d-flex flex-column">
                                <div className="card-body">
                                    <h5 className="card-title">2025 Paper</h5>
                                    <p className="card-text">2025 DSE Paper</p>
                                </div>
                                <div className="card-footer bg-transparent border-0">
                                    <a
                                        href="#"
                                        className="btn btn-info px-4 d-inline-flex gap-2"
                                        data-paper-id="2025_pp"
                                    >
                                        <BiDownload style={{ fontSize: 22 }} />
                                        Download
                                    </a>
                    ...
                    <div className="row row-cols-1 row-cols-md-3 g-4 mb-4">
                        <div className="col">
                            <div className="card h-100 d-flex flex-column">
                                <div className="card-body">
                                    <h5 className="card-title">2024 Paper</h5>
                                    <p className="card-text">2024 DSE Paper</p>
                                </div>
                                <div className="card-footer bg-transparent border-0">
                                    <a
                                        href="#"
                        ...
                        <div className="col">
                            <div className="card h-100 d-flex flex-column">
                                <div className="card-body">
                                    <h5 className="card-title">2024 Marking Scheme</h5>
                                    <p className="card-text">2024 Marking Scheme</p>
                                </div>
                                <div className="card-footer bg-transparent border-0">
                                    <a
                                        href="#"
