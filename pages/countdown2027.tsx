...
import { generateCountdown2027StructuredData, generatePageFAQStructuredData } from '../utils/structuredData'
...
export default function Countdown2027Page() {
    ...
    useEffect(() => {
        // Target DSE 2027 - April 8, 2027 at 9:00 AM HKT
        const targetDate = new Date('2027-04-08T09:00:00+08:00');
    ...
    const totalDaysUntilExam = 365; // Approximate days until DSE 2027
            ...
            <Head>
                ...
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify(generateCountdown2027StructuredData())
                    }}
                />
                <script
                    type="application/ld+json"
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify(generatePageFAQStructuredData('countdown2027'))
                    }}
                />
            ...
            <div className="card rounded-4 countdown-page">
                <div className="card-body">
                    ...
                    <div className="alert alert-warning d-flex align-items-center mb-4" role="alert">
                        ...
                        <div>
                            <strong>注意：</strong> 2027年DSE考試日期尚未正式公佈。此倒數計時器基於2026年考試日期推算，實際日期可能有所不同。請以香港考試及評核局(HKEAA)官方公佈為準。
                        </div>
                    </div>

                    {/* SVG Icons for Bootstrap Alert */}
