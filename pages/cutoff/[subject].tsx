...
const SUBJECT_ICONS: Record<string, { icon: any, color: string }> = {
  ...
  'math': { icon: BiCalculator, color: '#ffd600' },
  'citizen': { icon: BiGlobe, color: '#28a745' },
  'physics': { icon: BiBot, color: '#ffd600' },
  'chemistry': { icon: BiTestTube, color: '#00e676' },
  'biology': { icon: BiLeaf, color: '#00c853' },
  'ict': { icon: BiLaptop, color: '#ff3d00' },
  'm1': { icon: BiCalculator, color: '#b388ff' },
  'm2': { icon: BiCalculator, color: '#64ffda' },
  'geography': { icon: BiGlobe, color: '#00bfae' },
  'economics': { icon: BiMoney, color: '#ffd600' },
  'bafs': { icon: BiBriefcase, color: '#ffea00' },
