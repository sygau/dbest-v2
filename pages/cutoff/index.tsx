    ...
    <>
      ...
      <div className="card rounded-4" style={{ height: 'auto' }}>
        <div className="card-body" style={{ fontFamily: "var(--font-noto-sans-hk), 'PingFang HK', 'Microsoft JhengHei', -apple-system, BlinkMacSystemFont, sans-serif" }}>
          ...
          <div className="print:hidden my-6" style={{ minHeight: '280px', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: 'var(--color-card-inner-bg)', borderRadius: '8px', border: '1px solid var(--color-border)' }}>
            <ins
