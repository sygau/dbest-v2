  ...
  return (
    <>
      ...
      <Head>
        ...
        <script src="/assets/js/pace.min.js" defer />
        
        <style>{`
          /* Prevent white flash during navigation but preserve background images */
          html, body, #__next {
          ...
          * {
          ...
          /* Disable default browser page transition */
          body {
            overflow-x: hidden;
          }
          
          /* Pace.js customization */
          .pace .pace-progress {
