...
function SidebarLogo({ isMobileSheet }: { isMobileSheet?: boolean } = {}) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 192 192" role="img" aria-labelledby={!isMobileSheet ? "logoTitle" : undefined}>
      {!isMobileSheet && <title id="logoTitle">DSEBest Logo</title>}
      ...
      <div className={cn(
        ...
        <div className="flex-shrink-0">
          <NavigationLink href="/" aria-label="DSEBest 主頁 Home">
            <SidebarLogo isMobileSheet={isMobileSheet} />
          </NavigationLink>
        </div>
        {!collapsed && (
...
<MenuLabel isCollapsed={collapsed} isMobileSheet={isMobileSheet}>Offer</MenuLabel>
         ...
         {/*  <MenuLabel isCollapsed={collapsed} isMobileSheet={isMobileSheet}>核心科目</MenuLabel>
          ...
          <NavItem href="/vocab" icon={<BiBook style={{ color: '#8b5cf6', fontSize: 23 }} />} label="詞彙庫 Vocab Bank" isCollapsed={collapsed} isMobileSheet={isMobileSheet} />
