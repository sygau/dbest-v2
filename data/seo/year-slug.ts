...
export const yearSlugConfigs: Record<string, SubjectSEOConfig> = {
  math: {
    ...
    subjectLabel: 'DSE 數學 Mathematics',
  },
  english: {
    ...
    subjectLabel: 'DSE 英文 English Language',
  },
  physics: {
  ...
  chinese: {
    ...
    subjectLabel: 'DSE 中文 Chinese Language',
  },
  bafs: {
  ...
  'chinese-history': {
    ...
    subjectLabel: 'DSE 中國歷史 Chinese History',
  },
  economics: {
  ...
  citizen: {
    ...
    subjectLabel: 'DSE 公民與社會發展 Citizen',
  },
}
