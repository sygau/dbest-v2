...
export default function BlogPost({ post, relatedPosts, processedContent, headings }: BlogPostProps) {
  ...
  return (
    <>
      ...
      <PageBreadcrumb section="Blog" text={categoryDisplayName} />
          ...
          <div className="blog-main-content">
            <article className="card rounded-4">
              <div className="card-body" style={{ padding: 'clamp(1.25rem, 4vw, 2rem)' }} ref={contentRef}>
                ...
                <div className="flex flex-wrap items-center gap-3 mb-4" style={{ fontSize: '0.875rem', color: 'var(--bs-body-color)' }}>
                  {[
